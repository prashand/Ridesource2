...
public class PickupLocationActivity extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button requestRideButton = (Button)findViewById(R.id.RequestRideButton);
        requestRideButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(sessionmgr.isLoggedIn()){

                    sessionmgr.getUserObject().setLatitude(
                            pickupMarker.getPosition().latitude)
                            .setLongitude(pickupMarker.getPosition().longitude);
                    try {
                        User u = sessionmgr.getUserObject();
                        new UpdateUserAsyncTask().execute(u);
                    } catch (Exception e) {
                        Log.e("IOException", "Edit failed");
                    }
                }
            }
        });
